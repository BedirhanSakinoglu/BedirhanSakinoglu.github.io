...
function set_session_info($mysqli){
    ...
    if($_SESSION['delivery_type'] == "deliver_person") {
        header("location: customerDeliverPackage_courierToPerson.php");
    }
    else if($_SESSION['delivery_type'] == "deliver_pickup_location") {
        header("location: customerDeliverPackage_courierToPickupLocation.php");
    }
    else if($_SESSION['delivery_type'] == "deliver_address") {
        header("location: customerDeliverPackage_courierToAddress.php");
    }
}
