...
<div class="grid-container">
    ...
    <div class="grid-item"><p>Send Packages</p> <button class="send-button" onclick="location.href='customerCallCourier.php';" style="cursor: pointer;">Call Courier</button> <button class="send-button" onclick="location.href='customerDeliverPackage.php';" style="cursor: pointer;">Deliver Yourself</button></div>
    <div class='grid-item' onclick="location.href='customerPackages.php';" style="cursor: pointer;"><p>My Packages</p> <img src='../../asset/package.jpg' style='width:50%;height:60%'> </div>
    ...
    <div class="grid-item" onclick="location.href='customerCreateReport.php';" style="cursor: pointer;"><p>Create Report</p><img src="../../asset/report.png" style="width:30%;height:60%"></div>
